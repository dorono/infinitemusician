...
<div id="col-container" class="about-wrap">
	<?php
	echo '<div class="updated">' . wpautop( sprintf( __( 'See below for a list of the IgniteWoo products in use on %s. You can %s, as well as our %s on how this works. %s', 'ignition-updater' ), get_bloginfo( 'name' ), '<a href="https://ignitewoo.com/my-account/">view your licenses here</a>', '<a href="http://docs.ignitewoo.com/document/ignition-helper/?utm_source=helper">documentation</a>', '&nbsp;&nbsp;<a href="' . esc_url( add_query_arg( array( 'force-check' => '1' ), admin_url( 'update-core.php' ) ) ) . '" class="button">' . __( 'Check for Updates', 'ignition-updater' ) . '</a>' ) ) . '</div>' . "\n";
	?>
		<div class="col-wrap">
