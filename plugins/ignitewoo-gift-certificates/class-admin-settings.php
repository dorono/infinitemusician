...
class IgniteWoo_GC_Admin extends WC_Settings_API {
	...
	function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'order_status_trigger' => array(
						...
						'type' 			=> 'select',
						'default' 		=> 'completed',
						'options'		=> array( 'completed' => __( 'Completed', 'ignitewoo_gift_certs' ), 'processing' => __( 'Processing', 'ignitewoo_gift_certs' ) ),
			...
			'titleg' => array( 'title' => __( 'Selectable Amount Setup', 'ignitewoo_gift_certs' ), 'type' => 'title', 'desc' =>  __( 'Modify the text strings used by the Name Your Own Price extension.', 'ignitewoo_gift_certs' ), 'id' => 'woocommerce_nyp_options' ),
	...
	?>
		...
		<h3><?php _e('Gift Certificates Integration Settings', 'ignitewoo_gift_certs'); ?></h3>

		<p><?php _e('This module provides a way for you to customize some aspects of the email template for the Gift Certificates / Store Credit plugin.', 'ignitewoo_gift_certs'); ?></p>
		...
		<table class="form-table">
			...
			<td valign="top" style="vertical-align:top">
				    <div style="float:right;  width:250px; border: 3px solid #333; background-color: #f7f7f7; padding: 12px 0; font-weight:bold; font-style:italic; margin-top: 15px; text-align:center; border-radius:7px;-webkit-border-radius:7px">
					    ...
					    <br><br>
					    <a title=" <?php _e('More Extensions + Custom WooCommerce Site Development', 'ignitewoo_gift_certs'); ?> " href="http://ignitewoo.com" target="_blank" style="color:#0000cc; text-decoration:none"><?php _e('Contact us!<br>IgniteWoo.com now!', 'ignitewoo_gift_certs'); ?></a>
				    </div>
			</td>
		    </tr>
		</table>
