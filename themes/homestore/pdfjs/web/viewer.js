...
var pdfFromUrl = getParameterByName('pdf');
var DEFAULT_URL;

if (!pdfFromUrl) {
  DEFAULT_URL = 'Bulletproof_Saxophone_Playing-mobile.pdf';
} else {
  DEFAULT_URL = pdfFromUrl;
}



//var DEFAULT_URL = 'Bulletproof_Saxophone_Playing-mobile.pdf';
  ...
  (function () {
    ...
    (function (root, factory) {
      ...
      function configure(PDFJS) {
        ...
        PDFJS.cMapUrl = '../page-templates/cmaps/';
